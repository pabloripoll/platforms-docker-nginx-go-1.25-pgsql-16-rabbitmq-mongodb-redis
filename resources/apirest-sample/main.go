...
func main() {
    http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
        ...
        name := "myproj_local"
        user := "myproj"
        pass := "J4YPuJaieJ35gNAOSQQor87s82q2eUS1"
...
<head>
    <meta charset="utf-8">
    <title>GO HTML</title>
    <link rel="icon" type="image/x-icon" href="https://go.dev/favicon.ico">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="GO HTML">
    <style>
    :root {
        color-scheme: light dark;
        --light-bg: ghostwhite;
        --light-color: darkslategray;
        --light-code: rgb(60, 39, 245);
        --dark-bg: rgb(30, 30, 30);
        --dark-color: ghostwhite;
        --dark-code: rgb(103, 87, 255);
    }
    * {
    ...
    .logo {
        width: 300px; margin: 40px auto 10px auto;
    }
    svg {
        width: 300%;
    }
...
<body>
    <div class="logo">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 254.5 225" style="enable-background:new 0 0 254.5 225;" xml:space="preserve">
            <style type="text/css">
                .st0{fill:#2DBCAF;}
                .st1{fill:#5DC9E1;}
                .st2{fill:#FDDD00;}
    ...
    <header>
        <h1>PLATFORM <span>API REST</span> GO 1.25+</h1>
    </header>
    <p>Container is running successfully and serving plain <code>main.go</code> script with <span>HTML5</span> on <code>./var/www</code> directory.</p>
    <p>Database container status: `+ dbstatusMessage +`.</p>
</body>
</html>`)
